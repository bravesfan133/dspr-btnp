...
class Plugin:
    ...
    version = "1.0.0"
    description = (
        "Generates a custom B1G+ (Big Ten Plus) EPG from your IPTV playlist by matching "
        "BIG10+ streams to the Big Ten Plus schedule, then creates channels and assigns "
        "EPG data in Dispatcharr. Runs automatically after every M3U refresh, and can "
    ...
    actions = [
        {
            ...
            "confirm": "Run the B1G+ EPG sync now? This will create/update channels, refresh the EPG source, and refresh Channels DVR if configured.",
            "events": [],
        },
        {
            "id": "dry_run",
    ...
    fields = [
            ...
            },
            {
                ...
                "description": "First channel number assigned; each matched channel is numbered sequentially from its BIG10+ index.",
                "type": "number",
                "default": 900,
            },
            {
            ...
            },
            {
                ...
                "description": "Keyword used to find Big Ten Plus streams in the playlist (searched case-insensitively in stream names).",
                "type": "text",
                "default": "BIG10+",
            },
            {
                ...
                "description": "Number of extra days of Big Ten Plus schedule to fetch beyond today.",
                "type": "number",
                "default": 1,
            },
            {
                ...
                "description": "Similarity threshold (0.0 to 1.0) for fuzzy-matching playlist titles to Big Ten Plus events.",
                "type": "number",
                "default": 0.85,
            },
            {
            ...
            },
            {
                ...
                "description": "Fallback event duration in hours when the sport is not matched below.",
                "type": "number",
                "default": 3,
            },
            {
                "id": "baseball_duration_hours",
                "label": "Baseball Duration (hours)",
                "description": "Duration in hours applied to baseball events.",
                "type": "number",
                "default": 3.5,
            },
            {
                "id": "basketball_duration_hours",
                "label": "Basketball Duration (hours)",
                "description": "Duration in hours applied to basketball events.",
                "type": "number",
                "default": 3,
            },
            {
                "id": "football_duration_hours",
                "label": "Football Duration (hours)",
                "description": "Duration in hours applied to football events.",
                "type": "number",
                "default": 3.5,
            },
            {
                "id": "golf_duration_hours",
                "label": "Golf Duration (hours)",
                "description": "Duration in hours applied to golf events.",
                "type": "number",
                "default": 6,
            },
            {
                "id": "hockey_duration_hours",
                "label": "Hockey Duration (hours)",
                "description": "Duration in hours applied to hockey events.",
                "type": "number",
                "default": 3,
            },
            {
                "id": "soccer_duration_hours",
                "label": "Soccer Duration (hours)",
                "description": "Duration in hours applied to soccer events.",
                "type": "number",
                "default": 2.5,
            },
            {
                "id": "tennis_duration_hours",
                "label": "Tennis Duration (hours)",
                "description": "Duration in hours applied to tennis events.",
                "type": "number",
                "default": 3,
            },
            {
                "id": "volleyball_duration_hours",
                "label": "Volleyball Duration (hours)",
                "description": "Duration in hours applied to volleyball events.",
                "type": "number",
                "default": 2.5,
            },
            {
                "id": "gymnastics_dual_duration_hours",
                "label": "Gymnastics Dual Meet Duration (hours)",
                "description": "Duration in hours for gymnastics dual meets (two teams).",
                "type": "number",
                "default": 2,
            },
            {
                "id": "gymnastics_multi_duration_hours",
                "label": "Gymnastics Tri/Quad Meet Duration (hours)",
                "description": "Duration in hours for gymnastics tri or quad meets (three to four teams).",
                "type": "number",
                "default": 3.5,
            },
            {
